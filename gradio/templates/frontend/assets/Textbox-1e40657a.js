import { f as fade } from './Button-dca4c6c9.js';
import { B as BlockTitle } from './BlockTitle-26419c06.js';
...
function create_else_block(ctx) {
	...
	let mounted;
	let dispose;
	let if_block = /*show_label*/ ctx[5] && /*show_copy_button*/ ctx[9] && create_if_block_4(ctx);
	...
	return {
		...
		p(ctx, dirty) {
			if (/*show_label*/ ctx[5] && /*show_copy_button*/ ctx[9]) {
				if (if_block) {
					if_block.p(ctx, dirty);

					if (dirty[0] & /*show_label, show_copy_button*/ 544) {
			...
			if (!current || dirty[0] & /*readonly*/ 32768) {
				textarea.readOnly = /*readonly*/ ctx[15];
			}
...
function create_if_block(ctx) {
	...
	function select_block_type_1(ctx, dirty) {
		if (/*type*/ ctx[8] === "text") return create_if_block_1;
		if (/*type*/ ctx[8] === "password") return create_if_block_2;
		if (/*type*/ ctx[8] === "email") return create_if_block_3;
	}
...
// (200:2) {#if show_label && show_copy_button}
...
function create_else_block_1(ctx) {
	...
	return {
		c() {
			...
			attr(button, "class", "svelte-3gsie1");
		},
		m(target, anchor) {
...
function create_if_block_3(ctx) {
	...
	return {
		c() {
			...
			attr(input, "class", "scroll-hide svelte-3gsie1");
			attr(input, "placeholder", /*placeholder*/ ctx[2]);
			input.readOnly = /*readonly*/ ctx[15];
		...
		m(target, anchor) {
			...
			if (/*autofocus*/ ctx[11]) input.focus();
...
function create_if_block_1(ctx) {
	...
	return {
		c() {
			...
			attr(input, "class", "scroll-hide svelte-3gsie1");
			attr(input, "dir", input_dir_value = /*rtl*/ ctx[10] ? "rtl" : "ltr");
			attr(input, "placeholder", /*placeholder*/ ctx[2]);
			input.readOnly = /*readonly*/ ctx[15];
			input.autofocus = /*autofocus*/ ctx[11];

			attr(input, "style", input_style_value = /*text_align*/ ctx[12]
			? "text-align: " + /*text_align*/ ctx[12]
			: "");
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*rtl*/ 1024 && input_dir_value !== (input_dir_value = /*rtl*/ ctx[10] ? "rtl" : "ltr")) {
			...
			if (dirty[0] & /*text_align*/ 4096 && input_style_value !== (input_style_value = /*text_align*/ ctx[12]
			? "text-align: " + /*text_align*/ ctx[12]
			: "")) {
...
function create_fragment(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*lines*/ ctx[1] === 1 && /*max_lines*/ ctx[7] === 1) return 0;
		return 1;
	}
	...
	return {
		c() {
			...
			t = space();
			if_block.c();
			attr(label_1, "class", "svelte-3gsie1");
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ('show_copy_button' in $$props) $$invalidate(9, show_copy_button = $$props.show_copy_button);
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty[0] & /*value, el, lines, max_lines*/ 8323) {
		...
		if ($$self.$$.dirty[0] & /*disabled*/ 4194304) {
			$$invalidate(15, readonly = disabled);
		}
	};
...
export { Textbox as T };
//# sourceMappingURL=Textbox-1e40657a.js.map
