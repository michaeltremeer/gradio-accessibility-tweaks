import { f as fade } from './Button-fe2d8175.js';
import { B as BlockTitle } from './BlockTitle-dd453f5b.js';
import { C as Check } from './Check-c4e94d66.js';
import { C as Copy } from './Copy-ea2deb29.js';
import './Index-0da8b119.js';

const Textbox_svelte_svelte_type_style_lang = '';

/* Users/michaeltremeer/code/microsoft/gradio-accessibility-tweaks/js/textbox/shared/Textbox.svelte generated by Svelte v4.2.2 */
const {
	SvelteComponent,
	action_destroyer,
	add_render_callback,
...
function create_else_block(ctx) {
	...
	let mounted;
	let dispose;
	let if_block = /*show_label*/ ctx[7] && /*show_copy_button*/ ctx[11] && create_if_block_4(ctx);
	...
	return {
		c() {
			...
			attr(textarea, "class", "scroll-hide svelte-x7xgr0");
			attr(textarea, "dir", textarea_dir_value = /*rtl*/ ctx[12] ? "rtl" : "ltr");
			attr(textarea, "placeholder", /*placeholder*/ ctx[2]);
			attr(textarea, "rows", /*lines*/ ctx[1]);
			textarea.disabled = /*disabled*/ ctx[5];
			textarea.readOnly = /*readonly*/ ctx[6];
			textarea.autofocus = /*autofocus*/ ctx[13];

			attr(textarea, "style", textarea_style_value = /*text_align*/ ctx[14]
			? "text-align: " + /*text_align*/ ctx[14]
			: "");
		},
		m(target, anchor) {
			...
			current = true;
			if (/*autofocus*/ ctx[13]) textarea.focus();

			if (!mounted) {
				dispose = [
					action_destroyer(text_area_resize_action = /*text_area_resize*/ ctx[21].call(null, textarea, /*value*/ ctx[0])),
					listen(textarea, "input", /*textarea_input_handler*/ ctx[38]),
					listen(textarea, "keypress", /*handle_keypress*/ ctx[19]),
					listen(textarea, "blur", /*blur_handler_3*/ ctx[30]),
					listen(textarea, "select", /*handle_select*/ ctx[18]),
					listen(textarea, "focus", /*focus_handler_3*/ ctx[31]),
		...
		p(ctx, dirty) {
			if (/*show_label*/ ctx[7] && /*show_copy_button*/ ctx[11]) {
				if (if_block) {
					if_block.p(ctx, dirty);

					if (dirty[0] & /*show_label, show_copy_button*/ 2176) {
			...
			if (!current || dirty[0] & /*rtl*/ 4096 && textarea_dir_value !== (textarea_dir_value = /*rtl*/ ctx[12] ? "rtl" : "ltr")) {
			...
			if (!current || dirty[0] & /*text_align*/ 16384 && textarea_style_value !== (textarea_style_value = /*text_align*/ ctx[14]
			? "text-align: " + /*text_align*/ ctx[14]
			: "")) {
...
// (148:1) {#if lines === 1 && max_lines === 1}
function create_if_block(ctx) {
	let if_block_anchor;

	function select_block_type_1(ctx, dirty) {
		if (/*type*/ ctx[10] === "text") return create_if_block_1;
		if (/*type*/ ctx[10] === "password") return create_if_block_2;
		if (/*type*/ ctx[10] === "email") return create_if_block_3;
	}
...
// (203:2) {#if show_label && show_copy_button}
...
function create_else_block_1(ctx) {
	...
	return {
		c() {
			...
			attr(button, "class", "svelte-x7xgr0");
		},
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = listen(button, "click", /*handle_copy*/ ctx[17]);
				mounted = true;
			}
		},
		p: noop,
...
function create_if_block_3(ctx) {
	...
	return {
		c() {
			...
			attr(input, "class", "scroll-hide svelte-x7xgr0");
			attr(input, "placeholder", /*placeholder*/ ctx[2]);
			input.disabled = /*disabled*/ ctx[5];
			input.readOnly = /*readonly*/ ctx[6];
			input.autofocus = /*autofocus*/ ctx[13];
			attr(input, "autocomplete", "email");
		},
		m(target, anchor) {
			insert(target, input, anchor);
			set_input_value(input, /*value*/ ctx[0]);
			/*input_binding_2*/ ctx[37](input);
			if (/*autofocus*/ ctx[13]) input.focus();

			if (!mounted) {
				dispose = [
					listen(input, "input", /*input_input_handler_2*/ ctx[36]),
					listen(input, "keypress", /*handle_keypress*/ ctx[19]),
					listen(input, "blur", /*blur_handler_2*/ ctx[28]),
					listen(input, "select", /*handle_select*/ ctx[18]),
					listen(input, "focus", /*focus_handler_2*/ ctx[29])
				];
...
function create_if_block_2(ctx) {
	...
	return {
		...
		m(target, anchor) {
			insert(target, input, anchor);
			set_input_value(input, /*value*/ ctx[0]);
			/*input_binding_1*/ ctx[35](input);
			if (/*autofocus*/ ctx[13]) input.focus();

			if (!mounted) {
				dispose = [
					listen(input, "input", /*input_input_handler_1*/ ctx[34]),
					listen(input, "keypress", /*handle_keypress*/ ctx[19]),
					listen(input, "blur", /*blur_handler_1*/ ctx[26]),
					listen(input, "select", /*handle_select*/ ctx[18]),
					listen(input, "focus", /*focus_handler_1*/ ctx[27])
				];
...
function create_if_block_1(ctx) {
	...
	return {
		c() {
			...
			attr(input, "class", "scroll-hide svelte-x7xgr0");
			attr(input, "dir", input_dir_value = /*rtl*/ ctx[12] ? "rtl" : "ltr");
			attr(input, "placeholder", /*placeholder*/ ctx[2]);
			input.disabled = /*disabled*/ ctx[5];
			input.readOnly = /*readonly*/ ctx[6];
			input.autofocus = /*autofocus*/ ctx[13];

			attr(input, "style", input_style_value = /*text_align*/ ctx[14]
			? "text-align: " + /*text_align*/ ctx[14]
			: "");
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*rtl*/ 4096 && input_dir_value !== (input_dir_value = /*rtl*/ ctx[12] ? "rtl" : "ltr")) {
			...
			if (dirty[0] & /*text_align*/ 16384 && input_style_value !== (input_style_value = /*text_align*/ ctx[14]
			? "text-align: " + /*text_align*/ ctx[14]
			: "")) {
...
function create_fragment(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*lines*/ ctx[1] === 1 && /*max_lines*/ ctx[9] === 1) return 0;
		return 1;
	}
	...
	return {
		c() {
			...
			t = space();
			if_block.c();
			attr(label_1, "class", "svelte-x7xgr0");
			toggle_class(label_1, "container", /*container*/ ctx[8]);
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*show_label*/ 128) blocktitle_changes.show_label = /*show_label*/ ctx[7];
			if (dirty[0] & /*info*/ 16) blocktitle_changes.info = /*info*/ ctx[4];

			if (dirty[0] & /*label*/ 8 | dirty[1] & /*$$scope*/ 262144) {
			...
			if (!current || dirty[0] & /*container*/ 256) {
				toggle_class(label_1, "container", /*container*/ ctx[8]);
			}
		},
		i(local) {
...
function instance($$self, $$props, $$invalidate) {
	...
	function copy_feedback() {
		$$invalidate(16, copied = true);
		if (timer) clearTimeout(timer);

		timer = setTimeout(
			() => {
				$$invalidate(16, copied = false);
			},
			1000
		);
	}
	...
	$$self.$$set = $$props => {
		...
		if ('value_is_output' in $$props) $$invalidate(22, value_is_output = $$props.value_is_output);
		...
		if ('max_lines' in $$props) $$invalidate(9, max_lines = $$props.max_lines);
		if ('type' in $$props) $$invalidate(10, type = $$props.type);
		if ('show_copy_button' in $$props) $$invalidate(11, show_copy_button = $$props.show_copy_button);
		if ('rtl' in $$props) $$invalidate(12, rtl = $$props.rtl);
		if ('autofocus' in $$props) $$invalidate(13, autofocus = $$props.autofocus);
		if ('text_align' in $$props) $$invalidate(14, text_align = $$props.text_align);
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty[0] & /*value, el, lines, max_lines*/ 33283) {
...
export { Textbox as T };
//# sourceMappingURL=Textbox-f90bd065.js.map
